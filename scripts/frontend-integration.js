 ...
 * This file demonstrates how to integrate Questgaze with a web frontend
 */

// For React/Vue/Angular applications
export class QuestgazeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new QuestgazeClient(provider, contractAddress);
